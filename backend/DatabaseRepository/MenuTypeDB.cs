...
namespace backend.DatabaseRepository
{
    public class MenuTypeDB
    {
        ...
        public static List<MenuType> GetAllMenuTypes()
        {
            ...
            type1.DefaultStartTime = "08:00";
            type1.DefaultEndTime = "09:00";
            list.Add(type1);

            MenuType type2 = new MenuType();
            type2.MenuTypeId = 2;
            type2.Name = "Lunch";
            type2.DefaultStartTime = "12:00";
            type2.DefaultEndTime = "13:00";
            list.Add(type2);

            MenuType type3 = new MenuType();
            type3.MenuTypeId = 3;
            type3.Name = "Dinner";
            type3.DefaultStartTime = "18:00";
            type3.DefaultEndTime = "19:00";
            list.Add(type3);
